...
public class Docente {
    ...
    @OneToOne(cascade = CascadeType.ALL) @JoinColumn(name = "usuario_id", nullable = false, unique = true) private Usuario usuario;
    @ManyToOne @JoinColumn(name = "facultad_id") private Facultad facultad;
    @Column(length = 50) private String especialidad;
    @Column(nullable = false) private Boolean activo = true;
    public Docente() {}
    public Docente(Usuario u, Facultad f, String esp) { this.usuario = u; this.facultad = f; this.especialidad = esp; }
